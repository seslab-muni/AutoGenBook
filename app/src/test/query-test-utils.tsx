 ...
 * or, passing `{ queryClient }`, against one from an earlier render, so a test can unmount and
 * re-render a hook while keeping its cache (e.g. to exercise resume-after-remount behavior).
 */
